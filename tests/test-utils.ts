import { SuiClient, SuiObjectResponse, PaginatedEvents as SuiPaginatedEvents, SuiEvent, PaginatedObjectsResponse, SuiObjectData, SuiTransactionBlockResponse, PaginatedCoins } from '@mysten/sui/client';
import { Pool } from '../dex';
import { jest } from '@jest/globals';
import crypto from 'crypto';

// Re-export types from @mysten/sui/client for use in services
export type { SuiClient, SuiObjectResponse, SuiPaginatedEvents, SuiEvent, PaginatedObjectsResponse, SuiObjectData, SuiTransactionBlockResponse, PaginatedCoins };

// Mock SuiClient with proper type implementations
export interface MockSuiClientMethods {
  getObject: jest.Mock;
  queryEvents: jest.Mock;
  getTransactionBlock: jest.Mock;
  getDynamicFields: jest.Mock;
  getCoins: jest.Mock;
}

export interface MockSuiClient extends Omit<SuiClient, keyof MockSuiClientMethods>, MockSuiClientMethods {
}

export const mockSuiClient: MockSuiClientMethods = {
  getObject: jest.fn(),
  queryEvents: jest.fn(),
